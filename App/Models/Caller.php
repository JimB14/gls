...
class Caller extends \Core\Model
{
    /**
     ...
     */
    public static function doesCallerExist($email)
    {
        // echo "Connected to doesCallerExist()"; exit();

        // check if email is in `callers` table
        try
        {
            ...
            $caller = $stmt->fetch(PDO::FETCH_OBJ);
    ...
    /**
     * updates callers' billing and shipping info in `guests` table
     *
    ...
    /**
     * adds caller to `callers` table
     *
     * @param  Int      $email           The caller's email
     * @param  Array    $billing_data    Data from form
     * @param  Array    $shipping_data   Data from form
     * @return Array                     Result and new ID
     */
    public static function addCaller($email, $billing_data, $shipping_data)
    {
    ...
    /**
     * get caller record by ID
     *
     * @param  Int   $id   the ID of the record
     * @return Object     the guest record
     */
    public static function getCaller($id)
    {
        try
        {
            // establish db connection
    ...
    public static function getCallerByEmail($email)
    {
        try
        {
            // establish db connection

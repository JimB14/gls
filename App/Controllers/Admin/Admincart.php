...
class Admincart extends \Core\Controller
{
    // properties
    private $item = [];
    private $newItem = [];
    ...
    public function addToCartAction()
    {
        ...
        switch ($mvc_model) {
            ...
            case 'gtoflx':
                ...
                break;
            case 'stingray':
                $this->item = Stingray::getStingrayDetailsForAdminCart($id);
                break;
            case 'holster':
                $this->item = Holster::getHolsterDetailsForAdminCart($id);
                break;
            case 'battery':
